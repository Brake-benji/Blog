				...
				<form class="layui-form" action="" style="position: relative;top:10px;">
				  ...
				  <div class="layui-form-item" id="articleimg">
				    <label class="layui-form-label">选择文件</label>
	  	            ...
	  	            <br>
	  	            <img src="/Blog<?php echo ($detail["artpicture"]); ?>" id="oldimg" style="margin:10px 0px 10px 110px;width: 400px;height: 200px;">
	  	            <br/>
	  	          </div>
					...
					if(data.status=='error'){
					  ...
					  layer.msg('文章修改成功', {
						  ...
						  time: 2000 //2秒关闭（如果不配置，默认是3秒）
						   ...
						   window.location.href = "<?php echo U('Backend/Blog/Index');?>";
						}); 
				  	}	
				});
			    return false;
			  ...
			  layui.upload({
				  ...
				  success: function(res){
				  	if (res.status == "success") {
				  		...
				  		ct.push(	'<img src="/Blog'+res.data+'" style="margin:10px 0px 10px 110px;width:400px;height:200px;">');
				  		$('#oldimg').fadeOut();
