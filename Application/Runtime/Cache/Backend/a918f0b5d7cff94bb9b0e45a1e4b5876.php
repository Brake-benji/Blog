		...
		<div class="layui-layout layui-layout-admin">
			<div class="layui-header header header-demo">
				<div class="layui-main">
					<a class="logo" style="left: 0;" href="<?php echo U('Admin/Index/index');?>">
					...
					<ul class="layui-nav">
						...
						<li class="layui-nav-item">
							<a href="<?php echo U('Home/Index/index');?>" target="_blank">浏览网站</a>
						</li>
						<li class="layui-nav-item">
							<a href="javascript:;" class="admin-header-user">
							
								<?php echo session('user_info')['nick_name'];?>
							</a>
							<dl class="layui-nav-child">
								...
								<dd>
									<a href="javascript:;" id="changepwd"><i class="fa fa-gear" aria-hidden="true"></i> 修改密码</a>
								</dd>
								<dd>
			...
			<div class="layui-footer footer footer-demo">
				<div class="layui-main">
					<p>2017 &copy;
						<a href="<?php echo U('Admin/Other/index');?>">个人博客管理后台</a>
					</p>
				</div>
			</div>
			...
			<script>
				layui.use(['element', 'layer'], function() {
					...
					$('body').on('click','#changepwd',function(){
						var url = "<?php echo U('Index/changepwd');?>";
