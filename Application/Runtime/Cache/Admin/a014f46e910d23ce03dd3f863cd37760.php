			...
			<fieldset class="layui-elem-field">
				...
				<table class="layui-table">
					  ...
					  <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
					      ...
					      <td><img src="/AuthOne<?php echo ($v["filepath"]); ?>" style="width:300px;"></td>
					      ...
					      <td>
					        <?php if($v["is_valid"] == 'n'): ?><button class="layui-btn layui-btn-mini layui-btn-warm release" data="<?php echo ($v["id"]); ?>">
					      		<i class="layui-icon">&#xe608;</i>发布</button><?php endif; ?>
							<a data="<?php echo ($v["id"]); ?>" class="layui-btn layui-btn-mini layui-btn-normal edit"><i class="layui-icon">&#xe642;</i>编辑</a>
							<?php if($v["is_valid"] == 'y'): ?><a  data="<?php echo ($v["id"]); ?>" class="layui-btn layui-btn-danger layui-btn-mini del"><i class="layui-icon">&#xe640;</i>删除</a><?php endif; ?>
					      </td>
		...
		<script>
			layui.use(['laypage','layer','form'], function() {
				var laypage = layui.laypage,
					...
					//请求表单
				 $('.add').click(function(){
					var url = "<?php echo U('Other/releaseAd');?>";
				...
				$('.release').click(function(){
					...
					var url = "<?php echo U('Other/changeStatus');?>";
				...
				$('.del').click(function(){
					var id = $(this).attr('data');
					var url = "<?php echo U('Other/delAd');?>";
					layer.confirm('确定删除吗?', {
						  icon: 3,
						  skin: 'layer-ext-moon',
						  btn: ['确认','取消'] //按钮
