			...
			<div class="layout-left">
				<ul>
					<?php if(is_array($cate_list)): $i = 0; $__LIST__ = $cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="article-list">
						<img src="/Blog<?php echo ($v["artpicture"]); ?>">
						<br>
						...
						<a href="/Blog/index.php/Index/detail/id/<?php echo ($v["id"]); ?>" class="article_detail_btn">查看详情<i class="layui-icon" style="font-size: 20px;position: absolute;line-height: 40px;right: -2px;">&#xe602;</i></a>
