			...
			<div class="layout-left">
				<ul>
					<?php if(is_array($cate_list)): $i = 0; $__LIST__ = $cate_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li class="article-list">
						<a href="<?php echo U('Index/detail',array('id' => $v['id']));?>"><img src="/Blog<?php echo ($v["artpicture"]); ?>">
						</a>
						<br>
						...
						<span class="article_info">
							...
							<p class="article_content">
							<i class="layui-icon" style="font-size: 20px; color: #5FB878;">&#xe64d;</i>所属标签：<?php echo ($v["tagname"]); ?></p>
						</span>
